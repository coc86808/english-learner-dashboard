            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 sm:gap-4">
              {hscUnits.map((unit) => (
                <div
                  ...
                  className={`unit-card relative p-3.5 sm:p-5 rounded-2xl border border-white/15 cursor-pointer overflow-hidden transition-all duration-200 hover:scale-[1.01] hover:shadow-xl flex flex-col justify-between min-h-[120px] sm:min-h-[155px] group shadow-md ${unit.bgClass}`}
                >
