 ...
 * All options are single-word / short clean phrases — no dual "/" answers.
 * correctOption index matches the correct option in the options array.
...
export const hscQuestionsList = [
  // 1. Ambitious
  {
    id: 'hsc-u1-l1-01',
    word: 'Ambitious',
    bengaliMeaning: 'উচ্চাকাঙ্ক্ষী / বড় কিছু অর্জনের তীব্র ইচ্ছাপোষণকারী',
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the closest SYNONYM of the word "Ambitious"?',
    options: ['Aspiring', 'Lazy', 'Indifferent', 'Hesitant'],
    correctOption: 0,
  ...
  // 2. Unrealistic
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the ANTONYM of "Unrealistic"?',
    options: ['Impractical', 'Pragmatic', 'Illusionary', 'Futile'],
    correctOption: 1,
  ...
  // 3. Dreamer
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Noun',
    questionText: 'What does "Dreamer" mean in the context of idealistic thinkers?',
    options: ['Visionary', 'A sleeping person', 'A thief', 'A blacksmith'],
    correctOption: 0,
  ...
  // 4. Theorist
  {
    id: 'hsc-u1-l1-04',
    word: 'Theorist',
    bengaliMeaning: 'তত্ত্ববিদ / যিনি কেবল পুঁথিগত তত্ত্ব নিয়ে আলোচনা করেন',
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Noun',
    questionText: 'What is the closest SYNONYM of "Theorist"?',
    options: ['Ideologue', 'Practitioner', 'Labourer', 'Farmer'],
    correctOption: 0,
  ...
  // 5. Stupid
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the ANTONYM of the word "Stupid"?',
    options: ['Foolish', 'Intelligent', 'Dull', 'Dense'],
    correctOption: 1,
  ...
  // 6. Clever
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the closest SYNONYM of "Clever"?',
    options: ['Shrewd', 'Clumsy', 'Naive', 'Blunt'],
    correctOption: 0,
    synonyms: 'Shrewd, Astute, Quick-witted, Ingenious, Crafty',
    antonyms: 'Stupid, Clumsy, Foolish, Naive, Dull',
  ...
  // 7. Hypocritical
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What does "Hypocritical" mean in character evaluation?',
    options: ['Deceitful', 'Extremely honest', 'Very hardworking', 'Forgiving'],
    correctOption: 0,
  ...
  // 8. Over-enthusiastic
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the closest SYNONYM of "Over-enthusiastic"?',
    options: ['Overzealous', 'Apathetic', 'Indifferent', 'Reluctant'],
    correctOption: 0,
  ...
  // 9. Honest
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the ANTONYM of "Honest"?',
    options: ['Trustworthy', 'Deceitful', 'Upright', 'Candid'],
    correctOption: 1,
  ...
  // 10. Brave
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the closest SYNONYM of "Brave"?',
    options: ['Valiant', 'Timid', 'Cowardly', 'Fearful'],
    correctOption: 0,
  ...
  // 11. Likes flattery
  {
    id: 'hsc-u1-l1-11',
    word: 'Likes flattery',
    bengaliMeaning: 'তোষামোদ বা চাটুকারিতা পছন্দ করে এমন (চাটুকারপ্রিয়)',
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Phrase / Trait',
    questionText: 'Which word best describes a person who "Likes flattery"?',
    options: ['Vain', 'Humble', 'Modest', 'Critical'],
    correctOption: 0,
  ...
  // 12. Courageous
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the closest SYNONYM of "Courageous"?',
    options: ['Heroic', 'Pusillanimous', 'Scared', 'Hesitant'],
    correctOption: 0,
  ...
  // 13. Believes in hype
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Phrase / Trait',
    questionText: 'What does a person do who "Believes in hype"?',
    options: ['Gullibly accepts exaggeration', 'Verifies every fact', 'Doubts everything', 'Ignores publicity'],
    correctOption: 0,
  ...
  // 14. Go with the flow
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Idiom',
    questionText: 'What is the meaning of the idiom "Go with the flow"?',
    options: ['Conform to the current trend', 'Swim across a river', 'Lead a rebellion', 'Refuse cooperation'],
    correctOption: 0,
  ...
  // 15. Unlettered (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'In Paragraph 1, "It was unlettered." What is the SYNONYM of "Unlettered"?',
    options: ['Illiterate', 'Scholarly', 'Literate', 'Erudite'],
    correctOption: 0,
  ...
  // 16. Devour (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Verb',
    questionText: 'What is the ANTONYM of "Devour"?',
    options: ['Nibble', 'Gulp', 'Gobble', 'Swallow'],
    correctOption: 0,
  ...
  // 17. Deliberate (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Verb',
    questionText: '"The learned men of the court deliberated long." What does "Deliberate" mean?',
    options: ['Pondered carefully', 'Fought physically', 'Slept soundly', 'Sang songs'],
    correctOption: 0,
  ...
  // 18. Exquisite (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Adjective',
    questionText: 'What is the closest SYNONYM of "Exquisite"?',
    options: ['Magnificent', 'Ugly', 'Shoddy', 'Crude'],
    correctOption: 0,
  ...
  // 19. Scribe (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Noun',
    questionText: 'What was the primary duty of the "Scribes" in the story?',
    options: ['Copying manuscripts', 'Building the iron cage', 'Feeding grains to the bird', 'Catching wild birds'],
    correctOption: 0,
  ...
  // 20. Detractor (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Noun',
    questionText: 'What is the ANTONYM of "Detractor"?',
    options: ['Critic', 'Admirer', 'Slanderer', 'Adversary'],
    correctOption: 1,
  ...
  // 21. Slander (Core Textbook)
  {
    ...
    questionText: 'What is the closest SYNONYM of "Slander"?',
    options: ['Defamation', 'Tribute', 'Acclaim', 'Homage'],
    correctOption: 0,
  ...
  // 22. Impudence (Core Textbook)
  {
    ...
    unit: 'Unit 1: Lesson 1 (The Parrot\'s Tale)',
    partsOfSpeech: 'Noun',
    questionText: '"What impudence!" shouted the Police Inspector. What does "Impudence" mean?',
    options: ['Insolence', 'Humility', 'Obedience', 'Politeness'],
    correctOption: 0,
  ...
  // 23. Melancholy (Core Textbook)
  {
    ...
    questionText: 'What is the ANTONYM of "Melancholy"?',
    options: ['Sorrow', 'Exuberance', 'Gloom', 'Despair'],
    correctOption: 1,
