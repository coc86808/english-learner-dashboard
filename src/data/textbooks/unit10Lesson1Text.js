...
export const unit10Lesson1Textbook = {
  unitId: 'unit-10',
  unitTitle: 'Unit 10: Lifestyle',
  unitTitleBn: 'ইউনিট ১০: জীবনযাত্রা ও সংস্কৃতি',
  lessonId: 'u10-l1',
  lessonNumber: 'Lesson 1',
  title: 'Manners Around the World',
  titleBn: 'বিশ্বজুড়ে শিষ্টাচার ও সংস্কৃতি',
  author: 'NCTB English For Today',
  summaryBn: 'এই পাঠে বিশ্বের ৪টি ভিন্ন অঞ্চলের (চীন, দক্ষিণ আফ্রিকা, গ্রেট ব্রিটেন এবং মধ্যপ্রাচ্য) ডাইনিং শিষ্টাচার, উপহার প্রদানের সামাজিক নিয়ম এবং সম্ভাষণ বা গ্রিটিংসের অনন্য সাংস্কৃতিক বৈচিত্র্য তুলে ধরা হয়েছে। ভিন্ন সংস্কৃতির মানুষের সাথে সুষ্ঠু যোগাযোগ ও পারস্পরিক শ্রদ্ধাবোধ গড়ে তুলতে এসব আদব-কায়দা জানা অত্যন্ত জরুরি।',
  sections: [
    {
      paraNumber: 1,
      heading: 'China: Dining, Gift & Greetings Etiquette',
      headingBn: 'চীন: খাদ্যাভ্যাস, উপহার ও সম্ভাষণ শিষ্টাচার',
      region: 'China',
      flag: '🇨🇳',
      content: `Dining:
...
Gift:
Do present and receive things with both hands. Politely refusing a gift before accepting it is the norm in Chinese culture, so don't be discouraged when someone initially refuses your gift. White flowers are not good as gifts as they symbolise death.
...
Shake hands softly as a firm handshake could be considered a sign of aggression. It may make your Chinese friends feel uncomfortable. Greet the most senior first and gradually others. Children are expected to greet you rather than you greeting the children.`,
    ...
    {
      paraNumber: 2,
      heading: 'South Africa: Dining, Gift & Greetings Etiquette',
      headingBn: 'দক্ষিণ আফ্রিকা: খাদ্যাভ্যাস, উপহার ও সম্ভাষণ শিষ্টাচার',
      region: 'South Africa',
      flag: '🇿🇦',
      content: `Dining:
...
When dealing with foreigners, most South Africans shake hands with a smile while maintaining eye-contact. Some women do not shake hands and merely nod their head, so it is best to wait for a woman to extend her hand. Men may kiss a woman they know well on the cheek in place of a handshake. Greetings are leisurely and are marked by good cheers.`,
    ...
    {
      paraNumber: 3,
      heading: 'Great Britain: Dining, Gift & Greetings Etiquette',
      headingBn: 'গ্রেট ব্রিটেন: খাদ্যাভ্যাস, উপহার ও সম্ভাষণ শিষ্টাচার',
...
A handshake is the most common form of greeting among the British people and is customary when you are introduced to somebody new. It is only when you meet a friend of the opposite sex whom you haven't seen for a long time, that you would give a kiss on the cheek.`,
    ...
    {
      paraNumber: 4,
      heading: 'Middle East: Dining, Gift & Greetings Etiquette',
      headingBn: 'মধ্যপ্রাচ্য: খাদ্যাভ্যাস, উপহার ও সম্ভাষণ শিষ্টাচার',
      region: 'Middle East',
      flag: '🇸🇦',
      content: `Dining:
