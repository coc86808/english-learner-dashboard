<?php
/**
 * Automated WordPress Page Generator for HSC English Learner
 */
...
if ($sample_page) {
    ...
    echo "✓ Removed default Sample Page\n";
}
...
foreach ($pages as $p) {
    ...
    if (!$existing) {
        ...
        if (!is_wp_error($page_id)) {
            echo "✓ Created Page: {$p['title']} (ID: {$page_id})\n";
            $created_count++;
        }
    } else {
...
echo "\n🎉 All {$created_count} WordPress pages generated and published successfully!\n";
